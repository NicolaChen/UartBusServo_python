'''
来源: https://blog.csdn.net/weixin_44524040/article/details/102313428
稍作修改
'''
...
# objp = np.zeros((w*h,3), np.float32) #构造0矩阵，54行3列，用于存放角点的世界坐标
...
#     # 粗略找到棋盘格角点 这里找到的是这张图片中角点的亚像素点位置，共9×6=54个点，gray必须是8位灰度或者彩色图，（w,h）为角点规模
